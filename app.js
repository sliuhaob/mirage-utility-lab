import {maps,getMap,mapUtilities} from './maps.js?v=4';
...
if(document.modelContext?.registerTool){
 ...
 for(const [name,mapId,smokeOnly] of [['show_mirage_smoke','mirage',true],['show_mirage_utility','mirage',false],['show_nuke_utility','nuke',false],['show_ancient_utility','ancient',false],['show_dust2_utility','dust2',false]]){
