...
import {getMap} from './maps.js?v=12';
...
async function loadMap(view='radar'){
 ...
 try{
  ...
  else {const {createMap}=await import('./map.js?v=10');if(generation!==mapGeneration)return;next=await createMap($('#map-canvas'),$('#map-labels'),[],()=>{},()=>'',config,controller.signal,editor);}
